...
## Последнее обновление: 4 июля 2026 (сайт работает!)
...
- Страница входа/регистрации (login.html) — email + VK (временно недоступен)
- Просмотр приглашения (view.html)
- Трекер ответов (track.html)
- Админ-панель (admin.html) — статистика, пользователи, система
- Реклама Яндекс.Рекламы (R-A-19545012-1) — 4 слота
